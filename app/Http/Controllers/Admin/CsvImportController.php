...
class CsvImportController extends Controller
{
    ...
    {
        // dd($this->module);
        $config = collect(['sort' => $this->id_key, 'dir' => 'desc', 'limit' => 25, 'group' => 'participants.' . $this->id_key])->merge(request()->query())->toArray();
        ...
        if (request()->ajax()) {
            ...
            return view('admin.participants.grid', compact('paginate_OBJ', 'query'), ['_info' => $this->_info]);
        }
    }
    ...
    public function form()
    {
        ...
        // dd($clients->);
        return view('admin.participants.form', compact('row'));
    }
    ...
    public function import()
    {
        ...
        if (\request()->isMethod('POST')) {
            // $import_CLS = "ParticipantsImport";
            Excel::import(new \App\Imports\ParticipantsImport(), request()->file('clinical_protocol_document'));
