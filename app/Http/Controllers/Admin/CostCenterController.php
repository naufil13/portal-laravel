...
class CostCenterController extends Controller
{
    ...
    {
        $config = collect(['sort' => $this->id_key, 'dir' => 'desc', 'group' => 'cost_centers.' . $this->id_key])->merge(request()->query())->toArray();
        ...
        $SQL = $SQL->leftJoin('trials', 'trials.id', '=', 'cost_centers.clinical_trial_id');
        ...
        $paginate_OBJ
            ...
            ->transform(function ($item, $key) {
                ...
                return [
                    ...
                    'description' => Crypto::decryptData($item['description'], Crypto::getAwsEncryptionKey()),
                ];
            });
        ...
        if (request()->ajax()) {
            ...
            return view('admin.cost_centers.grid', compact('paginate_OBJ', 'query'), ['_info' => $this->_info]);
        }
    }
    ...
    public function form()
    {
        ...
        // dd($clients->);
        return view('admin.cost_centers.form', compact('row'));
    }
    ...
    public function store()
    {
        ...
        $data['data']['clinical_trial_id'] = request()->input('clinical_trial_id');
