...
class EventRegistrationController extends Controller
{
    ...
    {
        $config = collect(['sort' => $this->id_key, 'dir' => 'desc', 'group' => 'event_registrations.' . $this->id_key])->merge(request()->query())->toArray();
        ...
        if (request()->ajax()) {
            ...
            return view('admin.event_registrations.grid', compact('paginate_OBJ', 'query'), ['_info' => $this->_info]);
        }
    }
    ...
    public function form()
    {
        ...
        // dd($clients->);
        return view('admin.event_registrations.form', compact('row'));
    }
