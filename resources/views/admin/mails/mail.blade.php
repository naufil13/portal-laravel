...
<head>
    ...
    <title>Reset Your {{opt('site_title')}} Password</title>
...
<body style="
 ...
 text-align: left;
 " valign="top">
                                                                        <a href="{{opt('company_url')}}" style="mso-line-height-rule: exactly;
 ...
 padding-left: 0px; padding-top: 0; padding-bottom: 0; text-align:center;" valign="top">
                                                                        <img align="center" alt="Forgot your password?"
                                                                            class="mcnImage"
                                                                            src="https://i.ibb.co/df8D3zy/il-password-reset-2x.png"
 ...
 0; display: inline !important; vertical-align: bottom;" width="400">
 ...
 margin: 0;
 padding: 0;
 "><span style="text-transform:uppercase">Forgot</span></h1>
 ...
 margin: 0;
 padding: 0;
 "><span style="text-transform:uppercase">your password?</span></h2>
 ...
 color: #2a2a2a; font-family: &quot;Asap&quot;, Helvetica, sans-serif; font-size: 16px;
 line-height: 150%; text-align: center; padding-top:9px; padding-right: 18px;
 padding-bottom: 9px; padding-left: 18px;" valign="top">Dear {{ $email }} we got you! Let’s get you a new
                                                                        password.
                                                                        <br><br>
                                                                    </td>
                                                                </tr>
 ...
 padding-top:18px; padding-right:18px; padding-bottom:18px; padding-left:18px;" valign="top">
                                                        <table border="0" cellpadding="0" cellspacing="0"
                                                            class="mcnButtonBlock" style="border-collapse: collapse; mso-table-lspace: 0; mso-table-rspace: 0;
 -ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%; min-width:100%;" width="100%">
                                                            <tbody class="mcnButtonBlockOuter">
                                                                <tr>
 ...
 ">
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td align="center"
                                                                                        class="mcnButtonContent" style="mso-line-height-rule:
 exactly; -ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%;
 ...
 #FFFFFF; text-transform:uppercase;" target="_blank" title="{{opt('site_title')}} Reset Password">Reset password</a>
                                                                                    </td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
 ...
 -ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%; min-width:100%;" width="100%">
                                            <tbody class="mcnTextBlockOuter">
                                                <tr>
                                                    <td class="mcnTextBlockInner" style="mso-line-height-rule: exactly;
 -ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%" valign="top">
                                                        <table align="center" bgcolor="#F7F7FF" border="0"
                                                            cellpadding="32" cellspacing="0" class="card"
                                                            style="
 border-collapse: collapse;
 mso-table-lspace: 0;
 mso-table-rspace: 0;
 ...
 text-align: left; text-align: left; font-size: 14px; ">ERX strives to give you better ways to manage your clinical
                                                                            trial. We are on a mission to make you win
                                                                            in the digital space. Instead of manually
                                                                            storing and managing the clinical data, we
                                                                            help our partners meet their goals.</p>
 ...
 color: #246794;
 text-decoration:none;
 " target="_blank" title="Learn more about ERX">Learn More ❯</a>
                                                                        </div>
                                                                    </td>
                                                                </tr>
                                                            </tbody>
 ...
 font-size: 14px;
 " valign="top">
                                                                        <div style="text-align: center;">Copyright <?php echo date('Y'); ?>
                                                                            lathransoft.com - All Rights Reserved.</div>
                                                                    </td>
                                                                </tr>
                                                            </tbody>
                                                            <tbody></tbody>
