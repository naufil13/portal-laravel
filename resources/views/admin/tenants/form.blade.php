                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-6">
                                <input name="tenant_name"
                                    value="{{ old('tenant_name', $row->tenant_name ? Crypto::decryptData($row->tenant_name, Crypto::getAwsEncryptionKey()) : '') }}"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-6">
                                <input name="contact_person_name"
                                    value="{{ old('contact_person_name', Crypto::decryptData($row->contact_person_name, Crypto::getAwsEncryptionKey())) }}"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-6">
                                <input name="tenant_phone"
                                    value="{{ old('tenant_phone', $row->tenant_phone ? Crypto::decryptData($row->tenant_phone, Crypto::getAwsEncryptionKey()) : '') }}"
                        ...
                        <div class="form-group row">
                            <label for="module" class="col-3 col-form-label text-right required">Email:<span
                                    class="text-danger">*</span></label>
                            <div class="col-6">
                                <input name="tenant_email"
                                    value="{{ old('tenant_email', Crypto::decryptData($row->tenant_email, Crypto::getAwsEncryptionKey())) }}"
                                    class="form-control" type="text" placeholder="Enter Tenant Email">
                                    @error('tenant_email')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                            </div>
                        ...
                        <div class="form-group row">
                            <label for="module" class="col-3 col-form-label text-right required">Address:<span
                                    class="text-danger">*</span></label>
                            <div class="col-6">
                                <input name="tenant_address"
                                    value="{{ old('tenant_address', Crypto::decryptData($row->tenant_address, Crypto::getAwsEncryptionKey())) }}"
                                    class="form-control" type="text" placeholder="Enter Tenant Address">
                            </div>
                        </div>
